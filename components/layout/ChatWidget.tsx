...
const chatTopics: ChatTopic[] = [
  ...
  },
  {
    ...
    label: "Web広告",
    reply:
      "検索広告やSNS広告の初期設計、運用改善、ページ改善まで一緒に考えます。目的と予算感が分かると、出稿方法を整理しやすくなります。"
  },
  {
    id: "dx",
    label: "DX支援",
...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-[calc(env(safe-area-inset-bottom)+16px)] right-4 z-[60] flex flex-col items-end gap-3 md:bottom-14 md:right-6">
      {isOpen ? (
        <section
